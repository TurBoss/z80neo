...
;**************************************************************
;
;   Memory layout defined in z80neo.inc (included by top-level cpmz80neo.asm)
;
...
;   Set origin for CP/M
;
	; ORG set by top-level cpmz80neo.asm (SECTION CPM at CPM_BASE)
...
;
; End of BDOS — continues with bios.asm in the top-level build
